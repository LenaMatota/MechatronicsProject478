...
This section defines the technical performance measures (TPMs) which will be used to determine how well the joint design (NSoI) performs the required functions\footnote{TPMs are measurable and unambiguous parameters that can be influenced by designing the joint}, in Table~\ref{tab:TPMs} below.
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		TPM\_01 & FR\_01, FR\_05 & Run-out tolerance & \SI{1.571e-3}{rad} \\\hline
		TPM\_02 & FR\_02 & Holding torque & \SI{7.725}{Nm} \\\hline
		TPM\_03 & FR\_03, FR\_04 & Encoder accuracy & \SI{1000}{PPR} \\\hline
		TPM\_04 & FR\_01, FR\_02, FR\_05 & Joint life cycle & \num{e6} life cycles \\\hline
	\end{tabular}
\end{table}