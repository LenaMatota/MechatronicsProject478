...
\setcitestyle{numbers} % <--- THIS IS THE MISSING LINE
...
%==== Title Page =====================================================
\title{\textbf{Portable Coordinate Measuring Arm Joint Design}\\[2ex]
       \large Mechatronic Project 478\\Final Report\\[2ex]}                   
\author{\Large Author: Lena Matota\\ 
        \large 24989142 \\[5ex]
...
\include{chaps-front/chap-AI-use-2024}
...
\include{chaps-main/chap-requirement_analysis}
\include{chaps-main/chap-concept_development}
\include{chaps-main/chap-design_analysis}
\include{chaps-main/chap-design_evaluation}
\include{chaps-main/chap-experimental_procedure}
